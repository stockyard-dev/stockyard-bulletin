...
import (
	...
	"github.com/stockyard-dev/stockyard-bulletin/internal/license"
...
func main() {
	...
	licenseKey := os.Getenv("BULLETIN_LICENSE_KEY")
	...
	log.Printf("Stockyard Bulletin listening on :%s (tier: %s)", port, tier)
